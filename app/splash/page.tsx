        ...
        {!hasTransmitted ? (
          ...
          <div className="space-y-6 mt-12 animate-fade-in">
            ...
            <div className="space-y-4 pt-4">
              <p className="text-gray-400 text-sm">The mysteries deepen...</p>
              <a
                href="/"
                className="inline-block px-8 py-3 bg-gradient-to-r from-purple-600/80 to-pink-600/80 hover:from-purple-600 hover:to-pink-600 text-white font-medium rounded-full transition-all duration-300 hover:scale-105 border border-purple-400/30"
              >
                👁️ Enter the Eye
              </a>
            </div>
